...
public class Item : ItemMonoBehaviour, ISpriteRenderer, IField, IColorChangable
{
...
/// <param name="newType"></param>
    ...
    public void ChangeType(Action callback=null, bool dontDestroyForThisCombine = true)
    {
        if ( NextType != ItemsTypes.NONE )
        {
    ...
    IEnumerator ChangeTypeCor(Action callback=null,bool dontDestroyForThisCombine = true)
    {
